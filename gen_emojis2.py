...
NAV = '<header><div class="container"><nav><a class="logo" href="' + PREFIX + '/">&#x1F60A; <span data-i18n="siteName">EmojiWiki</span></a><a href="' + PREFIX + '/" data-i18n="navHome">Home</a><a href="' + PREFIX + '/about.html" data-i18n="navAbout">About</a><a href="' + PREFIX + '/privacy.html" data-i18n="navPrivacy">Privacy</a></nav></div></header>'
...
def make_emoji_page(e):
    head = make_head(
        ...
        "https://emojiwiki.world/emoji/" + e["id"] + ".html"
    )
    cp = e["codepoint"]
    css_cp = "\\" + cp.upper().replace(" ", "\\")
    body = '<!DOCTYPE html>\n<html lang="en">\n<head>\n' + head + '</head>\n<body>\n' + NAV + '\n<main class="container">\n'
    body += '<div class="breadcrumb"><a href="' + PREFIX + '/">Home</a> / ' + e["emoji"] + ' ' + e["name"] + '</div>\n'
...
grid = []
for e in emojis[:500]:
    grid.append('<a class="emoji-card" href="' + PREFIX + '/emoji/' + e["id"] + '.html"><span class="em">' + e["emoji"] + '</span><span class="label">' + e["name"][:20] + '</span></a>')
...
idx += '<p><a href="' + PREFIX + '/emoji/" data-i18n-v="view_all">View all ' + str(len(emojis)) + ' emojis \u2192</a></p>\n'
idx += '<div class="grid">\n' + "\n".join(grid) + '\n</div>\n'
idx += '</main>\n' + FOOTER + '\n<script src="' + PREFIX + '/i18n.js"></script>\n'
